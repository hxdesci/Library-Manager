...
function updateBookList(booksToDisplay = null) {
    ...
    const unavailableBooksDiv = document.getElementById('borrowed-books').querySelector('.book-list');  // Changed from unavailable-books to borrowed-books
...
document.addEventListener('DOMContentLoaded', function() {
    const libraryManager = {
        books: [],
        // ... rest of libraryManager implementation
    };

    // Make libraryManager globally available
    window.libraryManager = libraryManager;

    function updateBookList() {
        const availableBooksDiv = document.querySelector('#available-books .book-list');
        const unavailableBooksDiv = document.querySelector('#borrowed-books .book-list');  // Changed from unavailable-books to borrowed-books
        
        if (!availableBooksDiv || !unavailableBooksDiv) {
            console.error('Required DOM elements not found');
            return;
        }

        // ... rest of updateBookList implementation
    }
